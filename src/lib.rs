...
//! [<img alt="build status" src="https://img.shields.io/github/actions/workflow/status/udoprog/argwerk/ci.yml?branch=main&style=for-the-badge" height="20">](https://github.com/udoprog/argwerk/actions?query=branch%3Amain)
//!
